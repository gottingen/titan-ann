...
class DiskIndex:
    def __init__(
        ...
        """
        The tannpy.DiskIndex represents our python API into the Tann Product Quantization Flash Index library.

        This class is responsible for searching a Tann disk index.
