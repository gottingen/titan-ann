...
class StaticMemoryIndex:
    def __init__(
        ...
        """
        The tannpy.StaticMemoryIndex represents our python API into a static Tann InMemory Index library.
        ...
        :param data_path: The path to the vector bin file that created this index. Note that if you use a numpy
            ...
            ``tannpy.numpy_to_tann_file`` and provide the path to it here.
        :type data_path: str
