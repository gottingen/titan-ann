...
class DynamicMemoryIndex:
    def __init__(
        ...
        """
        The tannpy.DynamicMemoryIndex represents our python API into a dynamic Tann InMemory Index library.
    ...
    def consolidate_delete(self):
        """
        This method actually restructures the Tann index to remove the items that have been marked for deletion.
        """
