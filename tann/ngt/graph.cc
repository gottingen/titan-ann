...
void
NeighborhoodGraph::Property::set(tann::Property &prop) {
...
void
NeighborhoodGraph::Property::get(tann::Property &prop) {
...
void
NeighborhoodGraph::Search::normalizedCosineSimilarityFloat(NeighborhoodGraph &graph, tann::SearchContainer &sc,
...
void
NeighborhoodGraph::Search::cosineSimilarityFloat(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                 VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::CosineSimilarityFloat, DistanceCheckedSet>(sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedAngleFloat(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                VectorDistances &seeds) {
...
void
NeighborhoodGraph::Search::normalizedL2Float(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                             VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedL2Float, DistanceCheckedSet>(sc, seeds);
}

void
NeighborhoodGraph::Search::sparseJaccardFloat(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                              VectorDistances &seeds) {
...
void
NeighborhoodGraph::Search::normalizedCosineSimilarityFloat16(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                             VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedCosineSimilarityFloat16, DistanceCheckedSet>(sc, seeds);
}

void
NeighborhoodGraph::Search::cosineSimilarityFloat16(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                   VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::CosineSimilarityFloat16, DistanceCheckedSet>(sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedAngleFloat16(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                  VectorDistances &seeds) {
...
void
NeighborhoodGraph::Search::normalizedL2Float16(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                               VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedL2Float16, DistanceCheckedSet>(sc, seeds);
}

void
NeighborhoodGraph::Search::sparseJaccardFloat16(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                VectorDistances &seeds) {
...
// added by Nyapicom
void
NeighborhoodGraph::Search::poincareFloat16(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                           VectorDistances &seeds) {
...
void
NeighborhoodGraph::Search::cosineSimilarityFloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                                VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::CosineSimilarityFloat, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedAngleFloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                               VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedAngleFloat, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::angleFloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                     VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::AngleFloat, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::l1FloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                  VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L1Float, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::l2FloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                  VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L2Float, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedL2FloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                            VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedL2Float, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::sparseJaccardFloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                             VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::SparseJaccardFloat, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::poincareFloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                        VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::PoincareFloat, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::lorentzFloatForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                       VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::LorentzFloat, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::l1Uint8ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                  VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L1Uint8, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::l2Uint8ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                  VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L2Uint8, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::hammingUint8ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                       VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::HammingUint8, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::jaccardUint8ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                       VectorDistances &seeds) {
...
void
NeighborhoodGraph::Search::cosineSimilarityFloat16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                                  VectorDistances &seeds) {
...
void
NeighborhoodGraph::Search::normalizedAngleFloat16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                                 VectorDistances &seeds) {
...
void
NeighborhoodGraph::Search::angleFloat16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                       VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::AngleFloat16, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::l1Float16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                    VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L1Float16, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::l2Float16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                    VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L2Float16, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedL2Float16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                              VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedL2Float16, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::sparseJaccardFloat16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                               VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::SparseJaccardFloat16, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::poincareFloat16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                          VectorDistances &seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::PoincareFloat16, DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::lorentzFloat16ForLargeDataset(NeighborhoodGraph &graph, tann::SearchContainer &sc,
                                                         VectorDistances &seeds) {
...
NeighborhoodGraph::searchReadOnlyGraph(tann::SearchContainer &sc, VectorDistances &seeds) {
    ...
    distance_type explorationRadius = sc.explorationCoefficient * sc.radius;
    const size_t dimension = objectSpace->getPaddedDimension();
...
#endif
            distance_type distance = COMPARATOR::compare((void *) &sc.object[0],
...
NeighborhoodGraph::search(tann::SearchContainer &sc, VectorDistances &seeds) {
    ...
    while (!unchecked.empty()) {
        ...
        for (; neighborptr < neighborendptr; ++neighborptr) {
            ...
            distance_type distance = comparator(sc.object, *objectRepository.get(neighbor.id));
            sc.distanceComputationCount++;
            if (distance <= explorationRadius) {
    ...
    try {
        ...
        for (unsigned int i = 0; i < node.size() - 1; i++) {
            ...
            for (unsigned int j = i + 1; j < node.size(); j++) {
                ...
                assert(node[j].id != id);
#endif
                distance_type d = objectSpace->getComparator()(*objtbl[i], *objtbl[j]);
                if (d < mind) {
                    minj = j;
                    mind = d;
                }
...
public:
    ...
    tann::distance_type radius;
};

class TruncationSearchSharedData {
public:
    TruncationSearchSharedData(tann::NeighborhoodGraph &g, tann::ObjectID id, size_t size, tann::distance_type lr) :
            graphIndex(g), targetID(id), resultSize(size), explorationCoefficient(lr) {}

    tann::NeighborhoodGraph &graphIndex;
    tann::ObjectID targetID;
    size_t resultSize;
    tann::distance_type explorationCoefficient;
};

class TruncationSearchThread : public tann::Thread {
public:
    ...
    virtual int run() {
        tann::ThreadPool<TruncationSearchJob, TruncationSearchSharedData *, TruncationSearchThread>::Thread &poolThread =
                (tann::ThreadPool<TruncationSearchJob, TruncationSearchSharedData *, TruncationSearchThread>::Thread &) *this;
...
typedef tann::ThreadPool<TruncationSearchJob, TruncationSearchSharedData *, TruncationSearchThread> TruncationSearchThreadPool;
