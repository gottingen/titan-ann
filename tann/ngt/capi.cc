...
int32_t ngt_get_property_object_type(NGTProperty prop, NGTError error) {
    ...
    return static_cast<int32_t>((*static_cast<tann::Property *>(prop)).objectType);
}

bool ngt_is_property_object_type_float(int32_t object_type) {
    return (object_type == tann::DataType::Float);
}

bool ngt_is_property_object_type_float16(int32_t object_type) {
    return (object_type == tann::DataType::Float16);
}

bool ngt_is_property_object_type_integer(int32_t object_type) {
    return (object_type == tann::DataType::Uint8);
}
...
bool ngt_set_property_object_type_float(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).objectType = tann::DataType::Float;
    return true;
}
...
bool ngt_set_property_object_type_float16(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).objectType = tann::DataType::Float16;
    return true;
}
...
bool ngt_set_property_object_type_integer(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).objectType = tann::DataType::Uint8;
    return true;
}
...
bool ngt_set_property_distance_type_l1(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeL1;
    return true;
}
...
bool ngt_set_property_distance_type_l2(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeL2;
    return true;
}
...
bool ngt_set_property_distance_type_angle(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeAngle;
    return true;
}
...
bool ngt_set_property_distance_type_hamming(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeHamming;
    return true;
}
...
bool ngt_set_property_distance_type_poincare(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypePoincare;
    return true;
}
...
bool ngt_set_property_distance_type_lorentz(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeLorentz;
    return true;
}
...
bool ngt_set_property_distance_type_jaccard(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeJaccard;
    return true;
}
...
bool ngt_set_property_distance_type_sparse_jaccard(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeSparseJaccard;
    return true;
}
...
bool ngt_set_property_distance_type_normalized_l2(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeNormalizedL2;
    return true;
}
...
bool ngt_set_property_distance_type_cosine(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeCosine;
    return true;
}
...
bool ngt_set_property_distance_type_normalized_angle(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeNormalizedAngle;
    return true;
}
...
bool ngt_set_property_distance_type_normalized_cosine(NGTProperty prop, NGTError error) {
    ...
    (*static_cast<tann::Property *>(prop)).distanceType = tann::MetricType::MetricTypeNormalizedCosine;
    return true;
}

NGTObjectDistances ngt_create_empty_results(NGTError error) {
    try {
        return static_cast<NGTObjectDistances>(new tann::VectorDistances());
    } catch (std::exception &err) {
        std::stringstream ss;
        ss << "Capi : " << __FUNCTION__ << "() : Error: " << err.what();
        operate_error_string_(ss, error);
...
static bool ngt_search_index_(tann::Index *pindex, tann::Object *ngtquery, size_t size, float epsilon, float radius,
                              NGTObjectDistances results, int edge_size = INT_MIN) {
    // set search parameters.
    tann::SearchContainer sc(*ngtquery);      // search parametera container.

    sc.setResults(static_cast<tann::VectorDistances *>(results));          // set the result set.
...
static bool
ngt_linear_search_index_(tann::Index *pindex, tann::Object *ngtquery, size_t size, NGTObjectDistances results,
...
int32_t ngt_get_size(NGTObjectDistances results, NGTError error) {
    ...
    return (static_cast<tann::VectorDistances *>(results))->size();
}
...
NGTObjectDistance ngt_get_result(const NGTObjectDistances results, const uint32_t i, NGTError error) {
    try {
        tann::VectorDistances objects = *(static_cast<tann::VectorDistances *>(results));
...
void *ngt_get_object(NGTObjectSpace object_space, ObjectID id, NGTError error) {
    ...
    try {
        return (static_cast<tann::VectorSpace *>(object_space))->getObject(id);
    } catch (std::exception &err) {
        std::stringstream ss;
        ss << "Capi : " << __FUNCTION__ << "() : Error: " << err.what();
        operate_error_string_(ss, error);
...
void ngt_destroy_results(NGTObjectDistances results) {
    ...
    delete static_cast<tann::VectorDistances *>(results);
}
...
int32_t ngt_get_property_distance_type(NGTProperty prop, NGTError error) {
    ...
    return static_cast<int32_t>((*static_cast<tann::Property *>(prop)).distanceType);
}
...
bool ngt_optimizer_set(NGTOptimizer optimizer, int outgoing, int incoming, int nofqs,
    ...
    try {
        (static_cast<tann::GraphOptimizer *>(optimizer))->set(outgoing, incoming, nofqs, baseAccuracyFrom,
                                                              baseAccuracyTo,
...
bool ngt_get_edges(NGTIndex index, ObjectID id, NGTObjectDistances edges, NGTError error) {
    ...
    try {
        tann::VectorDistances &objects = *static_cast<tann::VectorDistances *>(edges);
