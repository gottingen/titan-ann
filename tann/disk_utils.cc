                               ...
                               const std::vector<std::string> &param_list)
{
    ...
    if (param_list.size() >= 6)
    {
        ...
        if (compress_ratio > 0 && compress_ratio <= 1)
        {
            ...
            {
                tann::cout << "Compress ratio:" << compress_ratio << " new #pq_chunks:" << chunks_by_cr << std::endl;
                              ...
                              const uint32_t Lf)
{
    ...
    for (int p = 0; p < num_parts; p++)
    {
        ...
        tann::Index<T> _index(compareMetric, shard_base_dim, shard_base_pts, false, false, false, build_pq_bytes > 0,
