...
#ifndef TANN_IO_MEMORY_READER_H_
#define TANN_IO_MEMORY_READER_H_
    ...
    namespace Helper {
        ...
        public:
            ...
            virtual std::shared_ptr<VectorSet> GetVectorSet(SizeType start = 0, SizeType end = -1) const {
                ...
                return std::shared_ptr<VectorSet>(new BasicVectorSet(
                        ByteArray((std::uint8_t *) (m_vectors->GetVector(start)),
                                  (end - start) * m_vectors->PerVectorDataSize(), false),
...
#endif // TANN_IO_MEMORY_READER_H_
