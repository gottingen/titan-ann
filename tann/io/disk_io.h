...
#ifndef TANN_IO_DISK_IO_H_
#define TANN_IO_DISK_IO_H_
    ...
    namespace Helper {
        ...
        struct AsyncReadRequest {
            ...
            AsyncReadRequest() : m_offset(0), m_readSize(0), m_buffer(nullptr), m_status(0), m_payload(nullptr),
                                 m_success(false), m_extension(nullptr) {}
        };
        ...
        public:
            ...
            ReadBinary(std::uint64_t readSize, char *buffer, std::uint64_t offset = UINT64_MAX) = 0;

            virtual std::uint64_t
            WriteBinary(std::uint64_t writeSize, const char *buffer, std::uint64_t offset = UINT64_MAX) = 0;
            ...
            virtual bool BatchCleanRequests(tann::Helper::AsyncReadRequest *readRequests,
                                            std::uint32_t requestCount) { return false; }
