...
namespace tann
{
    ...
    namespace KDT
    {
        ...
        private:
            ...
            int m_iHashTableExp;
            std::unique_ptr<tann::COMMON::IWorkSpaceFactory<tann::COMMON::WorkSpace>> m_workSpaceFactory;
...
#undef DefineKDTParameter
                ...
                m_workSpaceFactory = std::make_unique<tann::COMMON::ThreadLocalWorkSpaceFactory<tann::COMMON::WorkSpace>>();
            }
            ...
            ErrorCode SetWorkSpaceFactory(std::unique_ptr<tann::COMMON::IWorkSpaceFactory<tann::COMMON::IWorkSpace>> up_workSpaceFactory)
            {
                ...
                tann::COMMON::IWorkSpaceFactory<tann::COMMON::WorkSpace>* raw_specialized_ptr = dynamic_cast<tann::COMMON::IWorkSpaceFactory<tann::COMMON::WorkSpace>*>(raw_generic_ptr);
                ...
                {
                    m_workSpaceFactory = std::unique_ptr<tann::COMMON::IWorkSpaceFactory<tann::COMMON::WorkSpace>>(raw_specialized_ptr);
