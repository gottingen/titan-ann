...
DefineBasicParameter(m_valueType, tann::VectorValueType, tann::VectorValueType::Undefined, "ValueType")
DefineBasicParameter(m_distCalcMethod, tann::DistCalcMethod, tann::DistCalcMethod::Undefined, "DistCalcMethod")
DefineBasicParameter(m_indexAlgoType, tann::IndexAlgoType, tann::IndexAlgoType::KDT, "IndexAlgoType")
DefineBasicParameter(m_dim, tann::DimensionType, -1, "Dim")
DefineBasicParameter(m_vectorPath, std::string, std::string(""), "VectorPath")
DefineBasicParameter(m_vectorType, tann::VectorFileType, tann::VectorFileType::DEFAULT, "VectorType")
DefineBasicParameter(m_vectorSize, tann::SizeType, -1, "VectorSize")
...
DefineBasicParameter(m_queryType, tann::VectorFileType, tann::VectorFileType::Undefined, "QueryType")
DefineBasicParameter(m_querySize, tann::SizeType, -1, "QuerySize")
...
DefineBasicParameter(m_warmupType, tann::VectorFileType, tann::VectorFileType::Undefined, "WarmupType")
DefineBasicParameter(m_warmupSize, tann::SizeType, -1, "WarmupSize")
...
DefineBasicParameter(m_truthType, tann::TruthFileType, tann::TruthFileType::Undefined, "TruthType")
...
DefineSelectHeadParameter(m_datasetCapacity, int, tann::MaxSize, "DataCapacity")
