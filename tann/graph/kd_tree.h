...
#ifndef TANN_GRAPH_KD_TREE_H_
#define TANN_GRAPH_KD_TREE_H_
...
#pragma omp parallel for num_threads(numOfThreads)
            ...
            ErrorCode SaveTrees(std::shared_ptr<Helper::DiskIO> p_out) const
            {
                ...
                TLOG_INFO("Save KDT ({},{}) Finish!", m_iTreeNumber, treeNodeSize);
                return ErrorCode::Success;
            }

            ErrorCode SaveTrees(std::string sTreeFileName) const
            {
                TLOG_INFO("Save KDT to {}", sTreeFileName.c_str());
                auto ptr = f_createIO();
            ...
            ErrorCode LoadTrees(char*  pKDTMemFile)
            {
                ...
                TLOG_INFO("Load KDT ({},{}) Finish!", m_iTreeNumber, treeNodeSize);
                return ErrorCode::Success;
            }
            ...
            {
                TLOG_INFO("Load KDT From {}", sTreeFileName.c_str());
                auto ptr = f_createIO();
