...
#include "tann/core/search_result.h"
#include "tann/utility/common_utils.h"
#include "tann/utility/heap.h"
    ...
    namespace COMMON
    {
        ...
        public:
            ...
            inline int _CheckAndSet(SizeType* hashTable, int poolSize, bool isFirstTable, SizeType idx)
            {
                ...
                DoubleSize();
                TLOG_ERROR("Hash table is full! Set HashTableExponent to larger value (default is 2). NewHashTableExponent=%d NewPoolSize={}", m_exp, m_poolSize);
