...
#ifndef TANN_VECTOR_METADATA_SET_H_
#define TANN_VECTOR_METADATA_SET_H_
...
namespace tann {
    ...
    public:
        ...
        virtual ErrorCode
        SaveMetadata(std::shared_ptr<Helper::DiskIO> p_metaOut, std::shared_ptr<Helper::DiskIO> p_metaIndexOut) = 0;
        ...
        virtual ErrorCode RefineMetadata(std::vector<SizeType> &indices, std::shared_ptr<Helper::DiskIO> p_metaOut,
                                         std::shared_ptr<Helper::DiskIO> p_metaIndexOut) const;

        virtual ErrorCode RefineMetadata(std::vector<SizeType> &indices, const std::string &p_metaFile,
                                         const std::string &p_metaindexFile) const;

        static bool
        GetMetadataOffsets(const std::uint8_t *p_meta, const std::uint64_t p_metaLength, std::uint64_t *p_offsets,
    ...
    public:
        ...
        ErrorCode
        SaveMetadata(std::shared_ptr<Helper::DiskIO> p_metaOut, std::shared_ptr<Helper::DiskIO> p_metaIndexOut);
...
#endif // TANN_VECTOR_METADATA_SET_H_
