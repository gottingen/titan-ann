...
namespace tann {
    ...
    turbo::Status TsvVectorSetReader::init(turbo::SequentialReadFile *file, SerializeOption option) {
        _file = file;
        _option = option;
    ...
    turbo::Status TsvVectorSetWriter::init(turbo::SequentialWriteFile *file, SerializeOption option){
        _file = file;
        _option = option;
