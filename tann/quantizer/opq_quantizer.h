...
#ifndef TANN_QUANTIZER_OPQ_QUANTIZER_H_
#define TANN_QUANTIZER_OPQ_QUANTIZER_H_
...
namespace tann
{
    namespace COMMON
    {
        ...
        protected:
            ...
            const std::function<float(const OPQMatrixType*, const OPQMatrixType*, DimensionType)> m_fdot = tann::COMMON::DistanceCalcSelector<OPQMatrixType>(tann::DistCalcMethod::Cosine);
        ...
        ErrorCode OPQQuantizer<T>::LoadQuantizer(std::shared_ptr<Helper::DiskIO> p_in)
        {
            ...
            TLOG_INFO("After read OPQ Matrix.");
...
#endif  // TANN_QUANTIZER_OPQ_QUANTIZER_H_
