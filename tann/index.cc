                                                       ...
                                                       const std::vector<TagT> &tags)
{
    ...
    tann::cout << "Index built with degree: max:" << max << "  avg:" << (float)total / (float)(_nd + _num_frozen_pts)
                                   ...
                                   const IndexWriteParameters &parameters, const char *tag_filename)
{
    ...
    if (_enable_tags)
    {
        ...
        else
        {
            ...
            {
                throw tann::ANNException(std::string("Tag file") + tag_filename + " does not exist", -1, __FUNCSIG__,
                                            __FILE__, __LINE__);
            }
        }
    }
