...
namespace tann
{
    namespace COMMON
    {
        ...
        template<typename T>
        inline DistanceCalcReturn<T> DistanceCalcSelector(tann::DistCalcMethod p_method);
        ...
        public:
            ...
            template<typename T>
            static inline float ComputeDistance(const T* p1, const T* p2, DimensionType length, tann::DistCalcMethod distCalcMethod)
            {
        ...
        inline DistanceCalcReturn<T> DistanceCalcSelector(tann::DistCalcMethod p_method)
        {
            ...
            switch (p_method)
            {
            case tann::DistCalcMethod::InnerProduct:
            case tann::DistCalcMethod::Cosine:
#if TURBO_WITH_AVX512F
